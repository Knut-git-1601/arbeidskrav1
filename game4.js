...
function checkGameOver() {
  ...
  if (allHeroesDead && dragonAlive) {
    // Fjerner alle helter fra skjermen
    heroesArray.forEach((hero) => {
      // Går igjennom alle heltene i arrayet "heroesArray" med "forEach"
      const heroElement = document.getElementById(hero.id); // Henter DOM elementet for hver helt ved hjelp av heltenes unike id.
      if (heroElement) {
        // Sjekker om elementet faktisk finnes før det fjernes fra DOM (Document Object Model)
